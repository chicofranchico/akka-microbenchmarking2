...
import com.example.tutorial.MyProto
 ...
 */
class WorkerProtoBuf(coordRef: ActorRef, numWorkers: Int) extends Actor with IpDefinition {
  ...
  def receive = {
    ...
    case ping: Ping =>
      ...
      if (hops == 0)
        ...
        workers(Random.nextInt(numWorkers)) !  msg
 ...
 */
class MasterProtoBuf(numWorkers: Int, numMessages: Int, numHops: Int, repetitions: Int) extends Actor with IpDefinition {
 ...
 */
object RemoteRandomPingProtoBufMachine0 extends IpDefinition {
  ...
  def main(args: Array[String]): Unit = {
    ...
    remote.register("worker-service0", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    remote.register("worker-service1", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    remote.register("worker-service2", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    remote.register("worker-service3", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    ...
    // create the master
    remote.register("coord-service", actorOf(new MasterProtoBuf(workers, messages, hops, repetitions)))
 ...
 */
object RemoteRandomPingProtoBufMachine1 extends IpDefinition {
  ...
  def main(args: Array[String]): Unit = {
    ...
    remote.register("worker-service4", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    remote.register("worker-service5", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    remote.register("worker-service6", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
    remote.register("worker-service7", actorOf(new WorkerProtoBuf(coord, numWorkersTotal)))
